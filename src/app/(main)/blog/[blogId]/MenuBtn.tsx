...
export default function MenuBtn({ blogId, userId }: menuProp) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`absolute border w-40 py-1 shadow rounded-md divide-y-2 text-sm md:text-base -bottom-20 right-0 transition-opacity duration-500 bg-background z-50 ${
